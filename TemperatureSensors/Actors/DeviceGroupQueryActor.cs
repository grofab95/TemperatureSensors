...
namespace TemperatureSensors.Actors
{
    public class DeviceGroupQueryActor : UntypedActor
    {
        ...
        public DeviceGroupQueryActor(Dictionary<IActorRef, string> actorToDeviceId, long requestId, IActorRef requester, TimeSpan timeout)
        {
        ...
        public static Props Props(Dictionary<IActorRef, string> actorToDeviceId, long requestId, IActorRef requester, TimeSpan timeout) =>
            Akka.Actor.Props.Create(() => new DeviceGroupQueryActor(actorToDeviceId, requestId, requester, timeout));
    }
}
